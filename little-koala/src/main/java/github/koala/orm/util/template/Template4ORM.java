...
public class Template4ORM {
  ...
  public void generateTo() {
    ...
    String pojoPath = generator
        .generateTemplateTo(this, "template/orm-pojo.beelt", filePath + "/domian",
            pojoName + ".java");

    String interfacePath = generator
        .generateTemplateTo(this, "template/orm-interface.beelt", filePath + "/dao",
            pojoName + "Dao.java");

    String implementPath = generator
        .generateTemplateTo(this, "template/orm-implement.beelt", filePath + "/dao/impl",
            pojoName + "DaoImpl.java");

    log.info("ORM : Generate files :\n{}\n{}\n{}", pojoPath, interfacePath, implementPath);
  }
}
