...
public class ActorDaoImpl implements ActorDao{
  ...
  public Actor selectByKey(Integer actorId){
    return connection.executeQuery("select * from "+TABLE_NAME+" where actor_id= ?",Arrays.asList(actorId),Actor.class);
  }
  ...
  public int deleteByKey(Integer actorId){
    return connection.executeUpdate("delete from "+ TABLE_NAME +" where actor_id= ?",Arrays.asList(actorId));
  }
